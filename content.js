...
//
// This script is injected dynamically by background.js. Keep the entire
// implementation inside an IIFE and guard the isolated world so repeated
// chrome.scripting.executeScript() calls never redeclare top-level `let`
// bindings or register duplicate timers/listeners.
(() => {
  const GLOBAL_KEY = "__DUBWAVE_CONTENT_SCRIPT_LOADED__";
